...
local function PopulateMaze(Maze, CellsInfo)
	...
	if Game.UseMonsterBolster then
		GetMonster = function()
			...
			while MonSet.NoArena or MonSet.Type == 0 or Game.MonListBin[rnd].Radius > 180 or Game.MonstersTxt[rnd].Level > mapvars.MazeLevel*10 do
...
local function ExitMaze()
	evt.MoveToMap{0,0,0,0,0,0,0,1,"0"}
...
local function NextLevel()
	...
	evt.MoveToMap{0,0,0,0,0,0,0,2,"0"}
