...
mem.ExtendGameStructure{'Houses', Size = mmv(0x30, 0x34, 0x34),
	Refs = mmv(
	...
	EndRefs = mmv({0x4395EB}, {0x443C9B}, {0x440A9E}),
}
...
mem.autohook(mmv(0x43918F, 0x443862, 0x440681), function(d)
	...
	if mmver == 8 and n > 601 then
		mem.asmpatch(0x4416E8, [[
		cmp eax, 0x258
		jb @end
		cmp eax, 0x25A
		jb absolute 0x4416EF
		cmp eax, ]] .. (n + 1).. [[;
		@end:
		]])
	end
